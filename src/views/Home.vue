  ...
  >
    <div class="flex flex-col justify-center items-center z-10">
      ...
      />
        ...
        />
        <button class="ttt-button btn-2 mt-[2.12rem]" @click="createGame()">
          JOIN EXISTING GAME
        </button>
      </div>
    </div>
    <div class="flex h-full w-full absolute px-14 py-5">
      <div class="relative flex h-full w-full">
        ...
        <img
          :src="xSvg"
          class="ttt-icon absolute top-0 inset-x-1/2 -translate-x-2/4"
          alt="x"
        />
        ...
        <img
          :src="oSvg"
          class="ttt-icon absolute bottom-0 inset-x-1/2 -translate-x-2/4"
          alt="o"
        />
